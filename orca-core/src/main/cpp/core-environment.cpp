...
bool environment::checkSignature() {
    ...
    jmethodID get_hashcode_method_id = jniEnv->GetMethodID(signature_clz, AY_OBFUSCATE("hashCode"),
                                                           AY_OBFUSCATE("()I"));
...
jobject environment::checkApplicationContext(jobject context) {
    ...
    if (application_clz != nullptr) {
        ...
        jmethodID getNameMethod = jniEnv->GetMethodID(
                jniEnv->FindClass(AY_OBFUSCATE("java/lang/Class")), AY_OBFUSCATE("getName"),
        ...
        if (superClass != nullptr) {
            ...
            do {
                auto superClassName = (jstring) jniEnv->CallObjectMethod(nextSuperClz,
                                                                         getNameMethod);
